...
public class ZFlaxSpinnerOverlay extends Overlay
{
	...
	private final ZFlaxSpinnerPlugin plugin;
	private final ZFlaxSpinnerConfig config;
	private final PanelComponent panelComponent = new PanelComponent();

	@Inject
	private ZFlaxSpinnerOverlay(Client client, ZFlaxSpinnerPlugin plugin, ZFlaxSpinnerConfig config)
	{
		this.client = client;
		this.plugin = plugin;
		this.config = config;
